...
public class send {
    ...
    public static String myEmailAccount = "csxcsy1997@qq.com";
    public static String myEmailPassword = "muxgbvldtqepbchd";
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）
    public static String receiveMailAccount = "3503975695@qq.com";
    public static String[] receiveMailAccounts;
